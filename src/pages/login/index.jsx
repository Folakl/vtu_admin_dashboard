...
const Home = () => {
  ...
  return (
    <div className =" bg-blue-700 w-full lg:min-h-[700px] md:min-h-screen min-h-[700px] fixed ">
       <Header/>
      <div className="justify-self-center  bg-white lg:w-[400px]  md:w-[400px] w-[300px] lg:h-[450px] md:h-[600px] h-[540px] rounded-md  lg:m-5 md:m-20 m-5  p-8 ">
      ...
      <div className="relative lg:w-[350px] md:w-[350px] w-[250px] bg-[#f8f7f7] rounded-md  h-[50px]  mt-5 mb-2">
            <input
