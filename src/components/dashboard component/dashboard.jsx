...
export default function Dashboard() {
  ...
  return (
   <div className="pl-5">
           <div className="lg:flex md:flex grid h-full lg:mr-[50px] md:mr-5 mr-0">
      {/* Main Content */}
      <div className="flex-1 flex flex-col pt-6 pr-2">
        {/* Header */}
      ...
      <div className=" block w-80 border-l border-gray-200 p-6 ">
        ...
        <div>
          ...
          <div className="space-y-4">
            <ProfileItem name="Natasha Jones" role="Affiliate User" />
            <ProfileItem name="Natasha Jones" role="Affiliate User" />
            <ProfileItem name="Natasha Jones" role="Affiliate User" />
            <ProfileItem name="Natasha Jones" role="Affiliate User" />
            <ProfileItem name="Natasha Jones" role="Affiliate User" />
